...
//  UISegmentedControl
//
//  Created by Ibrahim on 15.07.2022.
//
...
class ViewController: UIViewController {
    ...
    var uiElements = ["UISegmentedControl", "UILabel","UISlaider",
                      "UITextField", "UIButton", "UIDatePicker"]
    ...
    override func viewDidLoad() {
        ...
        label.text = String(slider.value) //цифровое значение в текстовое
    ...
    @IBAction func switchAction(_ sender: UISwitch) {
        ...
        switchLabel.isHidden = !switchLabel.isHidden
